...
//* ROS2 includes
//* std_msgs in ROS 2 https://docs.ros2.org/humble/api/std_msgs/index-msg.html
...
{   
    ...
    private:
        ...
        std::string homeDir = "";
        std::string packagePath = "tello_ros_ws/src/ros2_orb_slam3/"; //! Change to match path to your workspace
